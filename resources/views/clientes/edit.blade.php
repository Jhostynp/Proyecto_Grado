...
<form action="{{route('clientes.uptade',$clientes->cli_id)}}" method="POST" onsubmit="return vali()">
@csrf
                <div class="form-group">
                    ...
                    <input type="text" value="{{$clientes->cli_name}}" name="cli_name" id="cli_name" class="form-control" placeholder="Escriba sus nombres">
                </div>

                <div class="form-group">
                    <label for="">Cedula: </label>
                    <input type="text" value="{{$clientes->cli_cedula}}"  name="cli_cedula" id="cli_cedula" class="form-control" placeholder="Escriba su numero de cedula" maxlength="10">
                </div>                


                <div class="form-group">
                    <label for="">Telefono: </label>
                    <input type="text" value="{{$clientes->cli_telefono}}"  name="cli_telefono" id="cli_telefono" class="form-control" placeholder="Escriba su Telefono" maxlength="10">
                </div>                
