...
<input class="form-control" name="pro_nombre" id="pro_nombre" placeholder="Escriba el nombre del producto" onkeypress="return soloLetras(event)">
 </div>


				<div class="form-group">
<label for="">Descripcion:</label>
	<input class="form-control" name="pro_descripcion" id="pro_descripcion" placeholder="Escriba la Descripcion" onkeypress="return soloLetras(event)">
